...
### ตัวอย่างการแปลงด้วย ADC

ADC 12-bit (0–4095) แรงดันอ้างอิง 3.3V

แรงดันอินพุต = 0.25V

ADC=0.253.3×4095≈310
...
```
อุณหภูมิ 25°C → แรงดัน 0.25V → ADC = 310
```

ADC คือ “ประตูสู่โลกดิจิทัล” เพราะมันทำให้ MCU สามารถอ่านค่าจากโลกจริงได้
